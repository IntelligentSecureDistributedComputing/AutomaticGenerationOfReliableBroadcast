...
3. On the folder  ```Generator``` run:
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Generator_shell.png?raw=true)
...
3. On the folder  ```Validator``` run:
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Validator_shell.png?raw=true)
...
3. On the folder  ```Client``` run:
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Client_shell.png?raw=true) 
...
3. On the folder  ```Generator``` run:
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Generator_docker_shell.png?raw=true) 
...
3. On the folder  ```Validator``` run:
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Validator_docker_shell.png?raw=true) 
...
3. On the folder  ```Client``` run:
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Client_docker_shell.png?raw=true) 
...
2. There you will see a ```FailureMode``` property containing 3 objects: ```NO_FAILURE```, ```CRASH_FAILURE``` and ```BYZANTINE_FAILURE```.
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Failure_mode_property.png?raw=true)
...
2. There you will see a ```NumberOfEpisodes``` property (default value is 1000) that you can change to a higher value.
    ...
    ![alt text](https://github.com/CyberIntelSearch/ReliableBroadcast/blob/main/misc/Number_of_episodes.png?raw=true)
